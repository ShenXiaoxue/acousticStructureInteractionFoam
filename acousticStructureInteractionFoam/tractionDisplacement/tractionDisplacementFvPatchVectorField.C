...
{
    Info << "1hahahahatraction" << nl << endl;
...
{
    Info << "2hahahahatraction" << nl << endl;
}
...
{
    Info << "3hahahahatraction" << nl << endl;
    fvPatchVectorField::operator=(patchInternalField());
    gradient() = vector::zero;
}
...
{
    Info << "4hahahahatraction" << nl << endl;
}
...
:
    ...
    pressure_(tdpvf.pressure_)
{
    Info << "5hahahahatraction" << nl << endl;
}
...
{
    Info << "6hahahahatraction" << nl << endl;
    if (updated())
    {
        return;
    }
    ...
    const fvPatchField<tensor>& gradU =
        patch().lookupPatchField<volTensorField, tensor>("grad(Usolid)");
